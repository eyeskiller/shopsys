...
Installation of Shopsys Framework is almost the same as is described in [Installation Using Docker](../installation/local-installation.md#installation-using-docker),
